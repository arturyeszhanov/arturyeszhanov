...
<p align="left">Frontend-разработчик с опытом создания адаптивных и интерактивных интерфейсов. Владею HTML, CSS, JavaScript, Vue.js, работаю с REST API, Git и сборщиками. Умею верстать по макетам (Figma), оптимизировать производительность и обеспечивать кроссбраузерность. Люблю чистый код, готов учиться новому и решать нестандартные задачи.<br><br>
